---
title: 前端系列（一）| Vue 快速入门
tags: Vue
categories: 前端
cover: https://s2.loli.net/2024/12/20/h9vq5GZdUgNanQC.jpg
abbrlink: 4425
date: 2021-09-25 18:50:21
---
# Vue 快速入门
...
![Vue 实例生命周期](https://cn.vuejs.org/assets/lifecycle_zh-CN.W0MNXI0C.png)
...
> 说明:通过将组件注册给对应`vue`实例中一个 `components`属性来完成组件注册,这种方式不会对`vue`实例造成累加
...
![](https://s2.loli.net/2024/12/20/lksY83NuQHj6bz2.png)

## 12.Vue路由

`注意事项`

![image-20241220010637764](https://s2.loli.net/2024/12/20/Ht3s6BWoJGSvQAp.png)
