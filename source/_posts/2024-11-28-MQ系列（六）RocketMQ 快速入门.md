...
![partition是什么](https://gcore.jsdelivr.net/gh/lingzhexi/blogImage/2024/12/202412171202431.jpeg)
...
> `kafka` 将主`broker` 中 `partition` **同步** `segment` 文件数据到到 从 `broker`的副本 `partition`下 `segement`文件
>
